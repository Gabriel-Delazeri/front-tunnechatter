...
const Navbar = () => {
  ...
  return (
    <nav className="z-10 bg-transparent top-0 left-0 w-full mb-10 sm:mb-20">
          ...
          <div className="flex items-center">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-4">
                <NavLink href="/albums" title="ALBUMS"></NavLink>
                <NavLink href="/reviews" title="REVIEWS"></NavLink>
              </div>
            </div>
          </div>
          <div className="hidden md:block">
